...
*/
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            comboBox2.Items.Add("Join Lobby");
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked)
            {
                ...
                if (comboBox2.Text == "Video Chat (inactive)")
                {
                    if (user.blocked.ContainsKey(comboBox1.Text))
                    {
                        MessageBox.Show("This user is blocked, unbloc and try again");
                ...
                if (comboBox2.Text == "Voice Chat (inactive)")
                {
                    if (user.blocked.ContainsKey(comboBox1.Text))
                    {
                        MessageBox.Show("This user is blocked, unbloc and try again");
                ...
                if (comboBox2.Text == "Text chat")
                {
                    if (user.blocked.ContainsKey(comboBox1.Text))
                    {
                        MessageBox.Show("This usercked, unbloc and try again");
                    }
                    else
                    {
                        ...
                        {
                            richTextBox1.Text = user.tempconvo[user.friendlist[comboBox1.Text]];
                            conversing = "conversation.txt";
                            user.setfile(conversing);
                            File.WriteAllText(user.getfile(), richTextBox1.Text);
                        }
                        else {
                            Random rand = new Random();
                            label1.Text = "Chatting with ... " + comboBox1.Text;
                            chatint = rand.Next(0, 1000);
                            user.friendlist[comboBox1.Text] = chatint;
